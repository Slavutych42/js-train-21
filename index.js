...
class Guitarist extends Musician {
  ...
  // перевизначений метод play(), що виводить рядок в консоль ${super.name} грає на ${super.instrument} в групі ${this.#b
  #band;
...
class Bassist extends Musician {
  ...
  // присвоює нове значення приватному полю #band
  // метод joinBand, що змінює значення #band,this.#band = band
  // перевизначений метод play(), що виводить рядок в консоль ${super.name} грає на ${super.instrument} в групі ${thi
  #band;
...
class Band {
  ...
  // Створюємо метод playMusic(), за допомогою forEach перебираємо масив і викликаємо метод play() для кожного учасника
...
class Performance {
  ...
  // Визначаємо метод info(), що виводить рядок в консоль `Гурт ${this.#band.name} виступить в ${this.#location} ${this.
  #band; 
  #location;
  #date; 
...
class Concert extends Performance {
  ...
  // Визначаємо метод info(), що виводить рядок в консоль `Гурт ${super.band.name} виступить в ${super.location} ${super
  #ticketPrice; 
 ...
 * | songs       | ["Yesterday","Hey Jude","Let It Be",]|
 */
const concert = new Concert(band, "BBC studios", new Date("1994-07-06"));
concert.ticketPrice = 100; 
